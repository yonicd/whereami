...
`r sprintf("![](https://img.shields.io/badge/clones-%s-9cf.svg)",readLines('https://mysterious-bayou-18627.herokuapp.com/clones?owner=yonicd&repo=whereami&stat=count',warn = FALSE))`
`r sprintf("![](https://img.shields.io/badge/views-%s-9cf.svg)",readLines('https://mysterious-bayou-18627.herokuapp.com/views?owner=yonicd&repo=whereami&stat=count',warn = FALSE))`
